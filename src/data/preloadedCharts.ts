...
export const PRELOADED_CHARTS: PreloadedChart[] = [
  ...
  },
  {
    ...
    data: [
      ...
      { Atividade: 'Correção de avaliação de alunos', 'Graduação (%)': 13.11, 'Pós-Graduação (%)': 10.56 },
      { Atividade: 'Recuperação de Informação', 'Graduação (%)': 53.72, 'Pós-Graduação (%)': 58.20 },
      { Atividade: 'Obtenção de inf. perguntas diretas', 'Graduação (%)': 63.88, 'Pós-Graduação (%)': 54.83 },
      ...
      { Atividade: 'Gestão e Organização de tarefas', 'Graduação (%)': 29.82, 'Pós-Graduação (%)': 22.69 },
    ],
  },
  {
    id: 'q5',
  ...
  },
  {
    ...
    data: [
      ...
      { Atividade: 'Correção de avaliação de alunos', 'Baixo Uso Grad (%)': 78.53, 'Rejeição Grad (%)': 86.88, 'Baixo Uso Pós (%)': 74.48, 'Rejeição Pós (%)': 89.67 },
      { Atividade: 'Recuperação de Informação', 'Baixo Uso Grad (%)': 34.83, 'Rejeição Grad (%)': 46.27, 'Baixo Uso Pós (%)': 35.82, 'Rejeição Pós (%)': 43.07 },
      { Atividade: 'Obtenção de inf. perguntas diretas', 'Baixo Uso Grad (%)': 48.84, 'Rejeição Grad (%)': 36.11, 'Baixo Uso Pós (%)': 49.89, 'Rejeição Pós (%)': 46.37 },
      ...
      { Atividade: 'Gestão e Organização de tarefas', 'Baixo Uso Grad (%)': 17.86, 'Rejeição Grad (%)': 70.17, 'Baixo Uso Pós (%)': 23.29, 'Rejeição Pós (%)': 77.80 },
    ],
  },
  {
    id: 'q7',

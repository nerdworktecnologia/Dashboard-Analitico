...
export const PRELOADED_CHARTS: PreloadedChart[] = [
  ...
  },
  {
    ...
    data: [
      ...
      { Unidade: 'Engenharia', Graduandos: 116, 'Pós-graduandos': 51 },
      { Unidade: 'FAFICH', Graduandos: 88, 'Pós-graduandos': 57 },
      { Unidade: 'Medicina', Graduandos: 59, 'Pós-graduandos': 24 },
      { Unidade: 'Letras', Graduandos: 60, 'Pós-graduandos': 17 },
      { Unidade: 'Econômicas', Graduandos: 39, 'Pós-graduandos': 35 },
      ...
      { Unidade: 'Arquitetura', Graduandos: 31, 'Pós-graduandos': 16 },
      { Unidade: 'Educação', Graduandos: 11, 'Pós-graduandos': 29 },
      { Unidade: 'Belas Artes', Graduandos: 28, 'Pós-graduandos': 9 },
      { Unidade: 'Farmácia', Graduandos: 27, 'Pós-graduandos': 7 },
      { Unidade: 'Enfermagem', Graduandos: 22, 'Pós-graduandos': 12 },
      { Unidade: 'Ed. Física', Graduandos: 14, 'Pós-graduandos': 19 },
      { Unidade: 'ICA', Graduandos: 11, 'Pós-graduandos': 3 },
      { Unidade: 'Veterinária', Graduandos: 9, 'Pós-graduandos': 4 },
      { Unidade: 'Odontologia', Graduandos: 6, 'Pós-graduandos': 4 },
      { Unidade: 'Música', Graduandos: 1, 'Pós-graduandos': 3 },
    ],
  },
  {
    id: 'q4',
